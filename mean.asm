...
;   Linux: nasm -f elf64 -l mean.lis -o mean.o mean.asm
...
;   The source code is free for use by members of the  programming course.
        ...
        extern sum
        global mean     ;Make this program callable by other programs. 
...
; rsi   - enterednumbers
; 	
	push     rsi			; save numbers
	call     sum
	pop      rsi
	
	cvtsi2sd   xmm1,esi     ; convert number to double
	
	divsd     xmm0,xmm1	; sum / number
